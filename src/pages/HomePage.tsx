  ...
  return (
    <div className="min-h-screen bg-noir noise-bg">
      ...
      <section className="relative h-screen flex items-center justify-center overflow-hidden">
        ...
        <div className="absolute top-1/4 left-8 md:left-16 text-gold/10 font-cormorant text-6xl md:text-9xl select-none pointer-events-none">
          I
        </div>
        <div className="absolute bottom-1/4 right-8 md:right-16 text-gold/10 font-cormorant text-6xl md:text-9xl select-none pointer-events-none">
          X
        </div>

        <div className="relative z-10 text-center px-6 max-w-4xl mx-auto">
          <div className="opacity-0 animate-fade-in-up delay-100">
            <span className="text-[10px] tracking-[0.6em] text-gold/50 uppercase font-montserrat font-light">
              Персональный фотожурнал
            </span>
          </div>

          <h1 className="opacity-0 animate-fade-in-up delay-200 font-cormorant font-light mt-6 leading-none">
            <span className="block text-7xl md:text-[120px] lg:text-[160px] gold-text tracking-tight">
              NOIR
            </span>
          </h1>
          ...
          <div className="opacity-0 animate-fade-in-up delay-500 mt-12 flex items-center justify-center gap-8">
            <button
      ...
      <section className="py-24 px-6 max-w-7xl mx-auto">
        <div className="flex items-center justify-between mb-16">
          <div>
            ...
            <h2 className="font-cormorant text-4xl md:text-5xl gold-text font-light">
              Последние работы
            </h2>
          </div>
          <button
      ...
      <section className="py-24 px-6 relative overflow-hidden">
        ...
        <div className="max-w-3xl mx-auto text-center relative z-10">
          ...
          <div className="mt-16 grid grid-cols-3 gap-8">
            {[
              { num: photos.length + '+', label: 'Фотографий' },
